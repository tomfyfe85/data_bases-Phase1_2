...
blog, post_title, post_content, , content_comments, name_comments
```
...
blog                      post_title post_content
content                   comments, name of contributer
...
CREATE TABLE comments (
  ...
  comment_content text,
  contrib_name text,
-- The foreign key name is always {other_table singula}_id
  post_id int,
